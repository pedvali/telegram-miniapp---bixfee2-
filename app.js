...
function getApiBase() {
    ...
    if (window.location.origin.includes('github.io')) {
        // ⚠️ مهم: URL Backend API خود را اینجا قرار دهید
        // راه‌اندازی Backend API:
        // 1. سرور Flask را روی VPS/Cloud اجرا کنید (miniapp_api.py)
        // 2. URL را اینجا قرار دهید (مثلاً: https://your-api.railway.app/api)
        // برای اطلاعات بیشتر به فایل راهنمای_Backend.md مراجعه کنید
        
        // ⚠️⚠️⚠️ این خط را تغییر دهید و URL واقعی Backend API خود را قرار دهید ⚠️⚠️⚠️
        // اگر Backend API روی همان سرور VPS است که ربات اجرا می‌شود:
        // return 'https://your-vps-domain.com/api';  // ← IP یا Domain سرور خود را بگذارید
        
        // اگر از Railway استفاده می‌کنید:
        // return 'https://your-app.railway.app/api';
        
        // اگر از Render استفاده می‌کنید:
        // return 'https://your-app.onrender.com/api';
        
        // ⚠️ برای تست محلی (اگر Backend روی localhost اجرا می‌شود):
        // return 'http://localhost:5000/api';  // ← فقط برای تست محلی
        
        // ⚠️ برای Production - URL واقعی Backend API خود را اینجا قرار دهید:
        // مثال: return 'https://api.yourdomain.com/api';
        // یا: return 'http://YOUR_SERVER_IP:5000/api';
        
        // ❌ اگر این خط null باشد، از Demo Mode استفاده می‌شود
        // ✅ برای استفاده واقعی، خط بالا را uncomment کنید و URL را تنظیم کنید
        return null; // ❌ تغییر دهید به URL واقعی Backend API
    }
    
    // برای Production - از همان origin استفاده کن
    // اگر Backend API روی همان سرور است از '/api' استفاده کن
    // در غیر این صورت URL کامل Backend را قرار دهید
